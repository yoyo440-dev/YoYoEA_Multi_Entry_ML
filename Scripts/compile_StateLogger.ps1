...
$sourceMq4 = '/home/anyo_/workspace/YoYoEA_Multi_Entry_ML/MQL4/Experts/MarketStateLogger.mq4'
$targetMq4 = '/mnt/d/Rakuten_MT4/MQL4/Experts/MarketStateLogger.mq4'
$logDir     = '/home/anyo_/workspace/shared/Compile_log'
...
$logFile   = Join-Path $logDir "StateLogger_$timestamp.log"
